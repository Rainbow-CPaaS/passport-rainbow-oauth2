 ...
 *   - `rainbowDomain` ( default: openrainbow.com ) you may specify an alternate rainbow domain ( i.e. sandbox.openrainbow.com )
  *
 * Examples:
 *
...
function Strategy(options, verify) {
  options = options || {};
  this.rainbowDomain = options.rainbowDomain || 'openrainbow.com';
  options.authorizationURL = options.authorizationURL || 'https://' + this.rainbowDomain + '/api/rainbow/authentication/v1.0/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://' + this.rainbowDomain + '/api/rainbow/authentication/v1.0/oauth/token';
...
Strategy.prototype.userProfile = function (accessToken, done) {
  ...
  this._oauth2.get('https://' + this.rainbowDomain + '/api/rainbow/enduser/v1.0/users/me', accessToken, function (err, body, res) {
    ...
    try {
      ...
      if (json.data.lastAvatarUpdateDate) {
        var pictureUrl = 'https://' + this.rainbowDomain + '/api/avatar/' + profile.id;
        var photo = {
          value: pictureUrl
        };
        photo.type = 'default';
